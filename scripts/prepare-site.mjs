...
const serviceContent = (area) => `<section class="moonstone-page-hero bg-purple text-base-light">
  <div class="container moonstone-section-pad">
...
<section class="bg-base-light">
  <div class="container moonstone-two-col moonstone-section-pad">
    <div class="content">
      <h2>How we help</h2>
...
const moonstoneFooter = `<footer class="overflow-hidden bg-navy text-base-light">
  <div class="container moonstone-footer-grid">
    <div>
...
body{margin:0;background:#fcf7fb;color:#181a34;font-family:Mulish,Arial,sans-serif}
a{color:inherit}
.container{width:100%;max-width:1200px;margin-left:auto;margin-right:auto}
header.menu{position:sticky;top:0;z-index:50;background:#fcf7fb;box-shadow:0 1px 0 rgba(24,26,52,.08)}
header.menu>.container{display:flex;align-items:center;justify-content:space-between;padding:1rem}
header.menu aside{display:flex;align-items:center}
header.menu nav{display:none;flex:1}
header.menu nav.hidden{display:none}
...
.font-heading{font-family:Jost,Arial,sans-serif}.font-bold{font-weight:700}
.btn{display:inline-flex;align-items:center;justify-content:center;border-radius:.25rem;padding:.85rem 1.25rem;font-family:Jost,Arial,sans-serif;font-weight:700;text-decoration:none}
.btn-primary{background:#f5bb20;color:#181a34}
.content h1,.content h2,.content h3{font-family:Jost,Arial,sans-serif;color:#181a34}
...
.moonstone-section-pad{padding:4.5rem 1rem}
.moonstone-two-col{display:grid;grid-template-columns:minmax(0,1fr) 360px;gap:3rem;align-items:start}
.moonstone-footer-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:2rem;padding:3rem 1rem}
.moonstone-footer-grid a{color:#fcf7fb;text-decoration:none}.moonstone-footer-grid a:hover{text-decoration:underline}
...
@media (max-width:767px){.moonstone-detail-grid,.moonstone-two-col,.moonstone-footer-grid{grid-template-columns:1fr}.moonstone-section-pad{padding:3rem 1rem}.moonstone-page-hero:after{width:120px;height:120px;right:-32px}}
